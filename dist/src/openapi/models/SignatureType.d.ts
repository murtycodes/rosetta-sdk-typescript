...
export declare function SignatureTypeFromJSON(json: any): SignatureType;
export declare function SignatureTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): SignatureType;
export declare function SignatureTypeToJSON(value?: SignatureType | null): any;
