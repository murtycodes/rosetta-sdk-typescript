...
export declare function CurveTypeFromJSON(json: any): CurveType;
export declare function CurveTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): CurveType;
export declare function CurveTypeToJSON(value?: CurveType | null): any;
//# sourceMappingURL=CurveType.d.ts.map