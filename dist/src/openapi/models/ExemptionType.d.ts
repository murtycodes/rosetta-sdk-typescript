...
export declare function ExemptionTypeFromJSON(json: any): ExemptionType;
export declare function ExemptionTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ExemptionType;
export declare function ExemptionTypeToJSON(value?: ExemptionType | null): any;
//# sourceMappingURL=ExemptionType.d.ts.map